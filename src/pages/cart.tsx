...
// ডামি কার্ট ডাটা (পরবর্তীতে Zustand স্টোর থেকে আসবে)
const initialCart =[
  {
    id: '1',
          ...
          <div className="flex flex-col lg:flex-row gap-6 md:gap-10">
            ...
            <div className="w-full lg:w-80 flex-shrink-0">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
                ...
                <Link to="/products" className="block text-center mt-4 text-sm font-medium text-gray-500 hover:text-primary transition-colors">
                  Continue Shopping
                </Link>
              </div>
            </div>
